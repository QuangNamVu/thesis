\begin{algorithm}[H]
	\KwData{T phiên giao dịch gồm tổng quát $\frac{N(N-1)}{2}$ cặp tương ứng với N đồng}
	\KwResult{Số lần xuất hiện vòng có xu hướng làm tăng số lượng đồng ban đầu}
	\textbf{Khởi tạo:}\\
	
	\begin{itemize}
		\item Đồ thị hai phía đầy đủ.
		\item Tensor $M$ kích thước TxNxN chứa giá trị của T phiên giao dịch.
	...
	\For{t trong T}{
		...
		\For{u, v trong $M_t$}{
		    $d(u,v) \gets -log(d(u,v)) - log(\epsilon))$
		}
		\Comment{Chuyển giá sang giá trị logarit}
