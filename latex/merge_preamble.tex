...
\PassOptionsToPackage{hyphens}{url}\usepackage[unicode]{hyperref}                   % Use hyphens PassOptions to add hyphenation in long urls
...
\usepackage[skip=7pt,
            ...
            font={small,sf},
            tableposition=top,
            figureposition=bottom]{caption}  % Table and figure caption format
...
% remove blank page between 2 chapter
